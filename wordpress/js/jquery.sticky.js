/*! For license information please see jquery.sticky.js.LICENSE.txt */
(() => {
  var e = {
      2265: (e, t, n) => {
        var r, i, o;
                ...
                var t = Array.prototype.slice,
                  ...
                  u = function () {
                    for (
                      ...
                      var f = s[l],
                        p = f.stickyWrapper.offset().top - f.topSpacing - u;
                      if (
                        (f.stickyWrapper.css(
                          "height",
                          f.stickyElement.outerHeight()
                        ),
                        t <= p)
                      )
                        null !== f.currentTop &&
                          ...
                          f.stickyElement.parent().removeClass(f.className),
                          f.stickyElement.trigger("sticky-end", [f]),
                          (f.currentTop = null));
                      else {
                        var d,
                          h =
                            ...
                            t -
                            u;
                        h < 0 ? (h += f.topSpacing) : (h = f.topSpacing),
                          f.currentTop !== h &&
                            (f.getWidthFrom
                              ? ((padding =
                                  f.stickyElement.innerWidth() -
                                  f.stickyElement.width()),
                                (d =
                                  e(f.getWidthFrom).width() - padding || null))
                              : f.widthFromWrapper &&
                                (d = f.stickyWrapper.width()),
                            null == d && (d = f.stickyElement.width()),
                            f.stickyElement
                              .css("width", d)
                              .css("position", "fixed")
                              .css("top", h)
                              .css("z-index", f.zIndex),
                            f.stickyElement.parent().addClass(f.className),
                            null === f.currentTop
                              ? f.stickyElement.trigger("sticky-start", [f])
                              : f.stickyElement.trigger("sticky-update", [f]),
                            (f.currentTop === f.topSpacing &&
                              f.currentTop > h) ||
                            (null === f.currentTop && h < f.topSpacing)
                              ? f.stickyElement.trigger(
                            ...
                            (f.currentTop = h));
                        var g = f.stickyWrapper.parent();
                        f.stickyElement.offset().top +
                          f.stickyElement.outerHeight() >=
                          g.offset().top + g.outerHeight() &&
                        f.stickyElement.offset().top <= f.topSpacing
                          ? f.stickyElement
                  ...
                  l = function () {
                    ...
                    for (var t = 0, n = s.length; t < n; t++) {
                      var r = s[t],
                        o = null;
                      r.getWidthFrom
                        ? r.responsiveWidth && (o = e(r.getWidthFrom).width())
                        : r.widthFromWrapper && (o = r.stickyWrapper.width()),
                        null != o && r.stickyElement.css("width", o);
                    }
                  },
                  c = {
                    init: function (t) {
                      return this.each(function () {
                        ...
                        i.wrapAll(function () {
                          if (0 == e(this).parent("#" + a).length) return u;
                        });
                        var l = i.parent();
                        n.center &&
                          l.css({
                    ...
                    unstick: function (t) {
                      return this.each(function () {
                        for (var t = e(this), r = -1, i = s.length; i-- > 0; )
                          s[i].stickyElement.get(0) === this &&
                            (n.call(s, i, 1), (r = i));
                        -1 !== r &&
                          (t.unwrap(),
                          t.css({
        ...
        !(function (t, n) {
              ...
              return (
                ...
                le(function (o, s, a, u) {
                  var l,
                    ...
                    y = n ? (i || (o ? e : h || r) ? [] : s) : v;
                  if ((n && n(v, y, a, u), r))
                    for (l = Te(y, d), r(l, [], a, u), c = l.length; c--; )
                      (f = l[c]) && (y[d[c]] = !(v[d[c]] = f));
                  if (o) {
                    if (i || e) {
                      if (i) {
                  ...
                  } else (y = Te(y === s ? y.splice(h, y.length) : y)), i ? i(null, s, y, u) : H.apply(s, y);
                })
              );
            }
            function Ee(e) {
              ...
              function (e, t) {
                E.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (P[e] || E.uniqueSort(i), W.test(e) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              }
                  ...
                  i = {
                    ...
                    then: function (e, n, i) {
                      ...
                      return E.Deferred(function (r) {
                        t[0][3].add(s(0, r, y(i) ? i : I, r.notifyWith)),
                          t[1][3].add(s(0, r, y(e) ? e : I)),
                          t[2][3].add(s(0, r, y(n) ? n : F));
                      }).promise();
                    },
                    promise: function (e) {
          ...
          function Me(e, t, n, r) {
            ...
            if (
              ...
              for (a = (s = E.map(be(i, "script"), Oe)).length; f < p; f++)
                (l = i),
                  f !== d &&
                    ((l = E.clone(l, !0, !0)),
                    a && E.merge(s, be(l, "script"))),
                  n.call(e[f], l, f);
              if (a)
                for (
                  c = s[s.length - 1].ownerDocument, E.map(s, We), f = 0;
                  f < a;
                  f++
                )
                  (l = s[f]),
          ...
          E.ajaxSetup({
            ...
            jsonpCallback: function () {
              var e = Qt.pop() || E.expando + "_" + St.guid++;
              return (this[e] = !0), e;
            },
          }),
            ...
            E.each(["top", "left"], function (e, t) {
              E.cssHooks[t] = Ge(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ve(e, t)), Fe.test(n) ? E(e).position()[t] + "px" : n
                  );
              });
            }),
